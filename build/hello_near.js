...
let NearlyDone = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = view(), _dec(_class = (_class2 = class NearlyDone {
  greeting = 'Name';
  tasks = [];
  ID = 0;
  ...
  fulfill_task({
    ...
    for (let i = 0; i < this.tasks.length; i++) {
      if (this.tasks[i].id === id) {
        ...
        task.fulfilled = true;
        log(`Task ${id} found! Fulfilling and returning stake...`);
        promiseBatchCreate(task.creator);
        promiseBatchActionTransfer(task.staked, 0);
        return;
      }
    }
...
}, (_applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_task", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "add_task"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "fulfill_task", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "fulfill_task"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_tasks", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "get_tasks"), _class2.prototype)), _class2)) || _class);
function get_tasks() {
  ...
  const _result = _contract.get_tasks(_args);
...
function fulfill_task() {
  ...
  const _args = NearlyDone._getArgs();
  const _result = _contract.fulfill_task(_args);
...
function add_task() {
  ...
  const _args = NearlyDone._getArgs();
  const _result = _contract.add_task(_args);
  NearlyDone._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(NearlyDone._serialize(_result, true));
}
...
export { add_task, fulfill_task, get_greeting, get_tasks, set_greeting };
